...
# UMAPs and cell type proportion stacked bar plots by condition saved to dataset specific final_outputs/ directories
prep_liana(object_list = object_list, file_path = "results/final_outputs/")
...
# Save split object list
```{r}
saveRDS(split_object_list, file = here("data", "ccc", "split_object_list.rds"))
```

# Prioritize ligands
* Sender cell populations: Astrocytes, Oligodendrocytes, Microglia, OPCs
* Receiver cell population: Excitatory and Inhibitory Neurons
```{r}
...
# number of unique ligands: 52 46 129 136 47 49
