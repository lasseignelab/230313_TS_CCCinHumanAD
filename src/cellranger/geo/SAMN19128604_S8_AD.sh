...
#SBATCH --error=SAMN19128604_S8_AD.err.txt
#SBATCH --output=SAMN19128604_S8_AD.out.txt
...
cellranger count --id=SAMN19128604_S8_AD \
                 ...
                 --sample=SRR14514033,SRR14514034,SRR14514035,SRR14514036,SRR14514037,SRR14514038,SRR14514039,SRR14514040 \