...
#SBATCH --error=SAMN19128607_S4_AD.err.txt
#SBATCH --output=SAMN19128607_S4_AD.out.txt
...
cellranger count --id=SAMN19128607_S4_AD \
                 ...
                 --sample=SRR14514001,SRR14514002,SRR14514003,SRR14514004,SRR14514005,SRR14514006,SRR14514007,SRR14514008 \