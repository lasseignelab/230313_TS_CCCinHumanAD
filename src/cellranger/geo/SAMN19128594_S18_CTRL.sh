...
#SBATCH --error=SAMN19128594_S18_CTRL.err.txt
#SBATCH --output=SAMN19128594_S18_CTRL.out.txt
...
cellranger count --id=SAMN19128594_S18_CTRL \
                 ...
                 --sample=SRR14514113,SRR14514114,SRR14514115,SRR14514116,SRR14514117,SRR14514118,SRR14514119,SRR14514120 \