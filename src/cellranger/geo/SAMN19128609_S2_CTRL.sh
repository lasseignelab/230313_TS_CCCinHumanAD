...
#SBATCH --error=SAMN19128609_S2_CTRL.err.txt
#SBATCH --output=SAMN19128609_S2_CTRL.out.txt
...
cellranger count --id=SAMN19128609_S2_CTRL \
                 ...
                 --sample=SRR14513985,SRR14513986,SRR14513987,SRR14513988,SRR14513989,SRR14513990,SRR14513991,SRR14513992 \