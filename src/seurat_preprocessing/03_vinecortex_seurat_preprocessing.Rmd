...
# Create seurat object
```{r}
merged_seurat <- make_seurat_object(here("data", "CellRangerCounts", "vine_cortex"))
```
...
# Plot QC metrics
```{r warning=FALSE}
pdf(file = here("results", "intermediate_outputs", "vine_cortex", "qc_plots.pdf"))
plot_qc(metadata)
dev.off()
```
...
```{r warning=FALSE}
pdf(file = here("results", "intermediate_outputs", "vine_cortex", "cellcycle_pca.pdf"))
...
```{r}
saveRDS(filtered_seurat, file = here("data", "vinecortex_integrated_seurat.rds"))
```
...
pdf(file = here("results", "intermediate_outputs", "vine_cortex", "clustree_umap.pdf"))
# plot clustree
tree
...
```{r warning=FALSE}
pdf(file = here("results", "intermediate_outputs", "vine_cortex", "feature_plots.pdf"))
