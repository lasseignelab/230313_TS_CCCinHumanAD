...
# Create seurat object
```{r}
merged_seurat <- make_seurat_object(here("data", "CellRangerCounts", "GSE174367"))
```
...
```{r}
filtered_seurat <- harmony_integration(filtered_seurat, dims = 1:30) # harmony converged after 2 iterations
```
...
tree
tree2
# plotting UMAP for most stable resolution (0.4)
...
# Find marker genes
```{r}
# Set the identity as Leiden with resolution 0.4
filtered_seurat <- SetIdent(filtered_seurat, value = "RNA_snn_res.0.4")
...
* Clusters unidentified are: 11, 16-22
```{r}
# vector of clusters of interest
identities <- c("11", "16", "17", "18", "19", "20", "21", "22")
...
loaded via a namespace (and not attached):
  [1] circlize_0.4.15        plyr_1.8.8             igraph_1.4.1          
 ...
 [13] magrittr_2.0.3         paletteer_1.5.0        tensor_1.5            
 [16] cluster_2.1.2          ROCR_1.0-11            tzdb_0.3.0            
 [19] globals_0.16.2         graphlayouts_0.8.4     matrixStats_0.63.0    
 [22] R.utils_2.12.2         timechange_0.2.0       spatstat.sparse_3.0-1 
 [25] colorspace_2.1-0       ggrepel_0.9.3          xfun_0.37             
 ...
 [37] future.apply_1.10.0    shape_1.4.6            abind_1.4-5           
 ...
 [49] ellipsis_0.3.2         ica_1.0-3              R.methodsS3_1.8.2     
 [52] pkgconfig_2.0.3        farver_2.1.1           uwot_0.1.14           
 [55] deldir_1.0-6           utf8_1.2.3             janitor_2.2.0         
 [58] tidyselect_1.2.0       rlang_1.0.6            reshape2_1.4.4        
 [61] later_1.3.0            munsell_0.5.0          tools_4.1.3           
 [64] cli_3.6.0              ggprism_1.0.4          generics_0.1.3        
 [67] ggridges_0.5.4         evaluate_0.20          fastmap_1.1.1         
 [70] yaml_2.3.7             goftest_1.2-3          rematch2_2.1.2        
 [73] knitr_1.42             fitdistrplus_1.1-8     tidygraph_1.2.3       
 [76] RANN_2.6.1             pbapply_1.7-0          future_1.32.0         
 [79] nlme_3.1-155           mime_0.12              R.oo_1.25.0           
 [82] ggrastr_1.0.1          compiler_4.1.3         rstudioapi_0.14       
 [85] beeswarm_0.4.0         plotly_4.10.1          png_0.1-8             
 [88] spatstat.utils_3.0-2   tweenr_2.0.2           stringi_1.7.12        
 [91] lattice_0.20-45        Matrix_1.5-3           vctrs_0.5.2           
 [94] pillar_1.8.1           lifecycle_1.0.3        spatstat.geom_3.1-0   
 [97] lmtest_0.9-40          GlobalOptions_0.1.2    RcppAnnoy_0.0.20      
[100] data.table_1.14.8      cowplot_1.1.1          irlba_2.3.5.1         
[103] httpuv_1.6.9           patchwork_1.1.2        R6_2.5.1              
[106] promises_1.2.0.1       KernSmooth_2.23-20     gridExtra_2.3         
[109] vipor_0.4.5            parallelly_1.34.0      codetools_0.2-18      
[112] MASS_7.3-55            rprojroot_2.0.3        withr_2.5.0           
[115] sctransform_0.3.5.9002 parallel_4.1.3         hms_1.1.2             
[118] grid_4.1.3             rmarkdown_2.20         snakecase_0.11.0      
[121] Rtsne_0.16             spatstat.explore_3.0-6 ggforce_0.4.1         
[124] shiny_1.7.4            ggbeeswarm_0.7.1 
