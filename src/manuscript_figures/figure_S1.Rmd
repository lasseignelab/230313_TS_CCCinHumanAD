...
---
**Plotting Supplemental Figure 1**

__Goal__: This is a script for generating supplemental figure 1 of my manuscript.
...
```{r}
df <- table(Idents(gse_object), gse_object$orig.ident) %>% as.data.frame()
...
png(here("results", "figures", "supp_figure1.png"),
  width = 300,
  height = 300,
  units = "mm",
  res = 300
