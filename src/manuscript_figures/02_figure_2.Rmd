...
png(here("results", "figures", "figure2.png"), width = 1200, height = 600)
fig2
dev.off()
```
...
ggplot(total_num, aes(x = sender, y = interactions)) +
...
ggplot(oi_num, aes(x = sender, y = interactions)) +
  geom_bar(stat = "identity") +
  xlab("Sender") +
  ylab("Number of Unique Interactions")
