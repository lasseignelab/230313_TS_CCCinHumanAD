...
png(here("results", "figures", "figure2.png"), width = 375, height = 250, units = 'mm', res = 300)
fig2
dev.off()
```
...
panel_A <- ggplot(prior_num2, aes(x = sender, y = interactions, fill = receiver)) +
  geom_bar(stat = "identity", position = "stack") +
  xlab("Sender") +
  ylab("Number of Interactions") +
  #ggtitle("Number of Unique Genes in Each Condition for Different Contexts") +
  ...
  scale_fill_discrete(name = "Receiver") +
  theme_bw()+
  geom_text(aes(label = interactions), position = "stack", vjust = 2, fontface = "bold") +
  scale_fill_manual(values = c(`Excitatory Neurons` = "slateblue3",
                               `Inhibitory Neurons` = "darkslategray3")) +
  labs(fill = "Receiver") +
  theme(legend.text = element_text(face = "bold")) +
...
png(here("results", "figures", "supp_figure2.png"), width = 500, height = 200, units = 'mm', res = 300)
supp_fig2
dev.off()
```
...
panel_C <- ggcorrplot(jaccard_ex_mat, outline.color = "white", lab = TRUE, lab_size = 5) +
  scale_fill_gradientn(limits = c(0, 1),
                       breaks = seq(0, 1, by = 0.2),
                       colors = colors,
                       name = "JI") +
...
panel_D <- ggcorrplot(jaccard_ex_mat, outline.color = "white", lab = TRUE, lab_size = 5) +
  scale_fill_gradientn(limits = c(0, 1),
                       breaks = seq(0, 1, by = 0.2),
                       colors = colors,
                       name = "JI") +
...
panel_E <- ggcorrplot(jaccard_ex_mat, outline.color = "white", lab = TRUE, lab_size = 5) +
  scale_fill_gradientn(limits = c(0, 1),
                       breaks = seq(0, 1, by = 0.2),
                       colors = colors,
                       name = "JI") +
