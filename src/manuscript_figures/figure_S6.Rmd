...
---
**Plotting Supplemental Figure 6**

__Goal__: This is a script for generating supplemental figure 6.
...
__Data__:
*Seurat objects*
* Name: sadick_processed_seurat.rds
...
```{r}
df <- table(Idents(sadick_object), sadick_object$orig.ident) %>% as.data.frame()
...
png(here("results", "figures", "supp_figure6.png"),
  width = 300,
  height = 300,
  units = "mm",
  res = 300
