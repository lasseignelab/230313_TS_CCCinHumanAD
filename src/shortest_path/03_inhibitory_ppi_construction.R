...
saveRDS(AD_igraph, file = paste0(wd, "/data/shortest_path/", name, "_AD_in_igraph.rds"))
saveRDS(CTRL_igraph, file = paste0(wd, "/data/shortest_path/", name, "_CTRL_in_igraph.rds"))
