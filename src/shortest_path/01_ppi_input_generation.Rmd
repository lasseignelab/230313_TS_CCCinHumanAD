...
vine_object <- readRDS(here(
  "data",
  "seurat_preprocessing",
  "vine_processed_seurat.rds"
))

vine_cortex_object <- readRDS(here(
  "data",
  "seurat_preprocessing",
...
Warning:  we couldn't map to STRING 42% of your identifiers
Warning:  we couldn't map to STRING 44% of your identifiers
Warning:  we couldn't map to STRING 39% of your identifiers
Warning:  we couldn't map to STRING 37% of your identifiers
